      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold text-gray-900">AptSo</span>
          </div>
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="bg-gradient-to-r from-blue-600 to-purple-700 text-white px-6 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-purple-800 transition-all duration-300 shadow-sm hover:shadow-md"
                >
                  Dashboard
                </a>
              </div>
